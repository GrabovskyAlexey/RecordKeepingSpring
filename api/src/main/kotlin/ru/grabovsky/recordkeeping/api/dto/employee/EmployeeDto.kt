...
data class EmployeeDto(
    ...
    @field:Size(min = 6, max = 100, message = "{validation.employee.company.nonEmpty}")
    @Schema(description = "swagger.employee.name", example = "Иванов И.И.")
    @JsonProperty("employeeName")
    val name: String,
    @field:NotEmpty(message = "{validation.employee.company.nonEmpty}")
    @Schema(description = "swagger.employee.company")
